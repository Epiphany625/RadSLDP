...
def evaluate(
    ...
    if bootstrap_ci:
        for key in ("micro", "macro"):
            ...
            vilmedic_cr[key]["mean"] = np.mean(bs.bootstrap_distribution)
            vilmedic_cr[key]["std"] = np.std(bs.bootstrap_distribution)
    ...
    if bootstrap_ci:
        for key in ("micro", "macro"):
            ...
            vilmedic_cr5[key]["mean"] = np.mean(bs.bootstrap_distribution)
            vilmedic_cr5[key]["std"] = np.std(bs.bootstrap_distribution)
    ...
    if bootstrap_ci:
        for key in ("micro", "macro"):
            ...
            vilmedic_cr_p[key]["mean"] = np.mean(bs.bootstrap_distribution)
            vilmedic_cr_p[key]["std"] = np.std(bs.bootstrap_distribution)
    ...
    if bootstrap_ci:
        for key in ("micro", "macro"):
            ...
            vilmedic_cr5_p[key]["mean"] = np.mean(bs.bootstrap_distribution)
            vilmedic_cr5_p[key]["std"] = np.std(bs.bootstrap_distribution)
